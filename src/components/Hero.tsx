          ...
          <div className="flex flex-col items-center gap-[60px] w-full">
            ...
            <div className="flex flex-col items-center gap-6 w-full text-center">
              ...
              <motion.div
                ...
                className="relative inline-flex items-center gap-[10px] rounded-[40px] bg-black overflow-visible invisible"
              >
                <div
              ...
              >
                <HeroButton onClick={openBooking}>Book Now</HeroButton>
