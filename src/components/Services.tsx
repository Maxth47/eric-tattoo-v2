...
const marqueeRow1 = [
  { icon: <MIcon d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,160H40V56H216V200ZM184,96a8,8,0,0,1-8,8H80a8,8,0,0,1,0-16h96A8,8,0,0,1,184,96Z" />, text: "Slide Decks" },
  { icon: <MIcon d="M224,76.68,179.32,32a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L224,99.31A16,16,0,0,0,224,76.68ZM92.69,208H48V163.31l88-88L180.69,120Z" />, text: "Copywriting" },
  { icon: <MIcon d="M200,136a8,8,0,0,1-8,8H136v56a8,8,0,0,1-16,0V144H64a8,8,0,0,1,0-16h56V72a8,8,0,0,1,16,0v56h56A8,8,0,0,1,200,136ZM208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208V208Z" />, text: "Brand Graphics" },
  { icon: <MIcon d="M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V64A16,16,0,0,0,216,48ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm120,24V200H40V64Z" />, text: "Brand Migration" },
  { icon: <MIcon d="M223.68,66.15,135.68,18a15.88,15.88,0,0,0-15.36,0l-88,48.17a16,16,0,0,0-8.32,14v95.64a16,16,0,0,0,8.32,14l88,48.17a15.88,15.88,0,0,0,15.36,0l88-48.17a16,16,0,0,0,8.32-14V80.18A16,16,0,0,0,223.68,66.15ZM128,32l80.34,44L128,120,47.66,76ZM40,90l80,43.78v85.79L40,175.82Zm96,129.57V133.82L216,90v85.78Z" />, text: "Package Design" },
  { icon: <MIcon d="M178.16,143.63,128,120,178.16,96.37a8,8,0,0,0-4.32-14.74L128,93.09,82.16,81.63a8,8,0,0,0-4.32,14.74L128,120,77.84,143.63a8,8,0,0,0,4.32,14.74L128,146.91l45.84,11.46a8,8,0,0,0,4.32-14.74ZM128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z" />, text: "Branding" },
];

const marqueeRow2 = [
  { icon: <MIcon d="M213.66,82.34l-56-56a8,8,0,0,0-11.32,0l-56,56a8,8,0,0,0,11.32,11.32L136,59.31V168a8,8,0,0,0,16,0V59.31l34.34,34.35a8,8,0,0,0,11.32-11.32ZM200,216a8,8,0,0,1-8,8H64a8,8,0,0,1,0-16H192A8,8,0,0,1,200,216Z" />, text: "Optimization" },
  { icon: <MIcon d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-120a8,8,0,0,0-8,8v56a8,8,0,0,0,16,0V104A8,8,0,0,0,120,96Zm36,0a8,8,0,0,0-8,8v56a8,8,0,0,0,16,0V104A8,8,0,0,0,156,96Z" />, text: "Brand Landing Pages" },
  { icon: <MIcon d="M164.44,105.34l-48-32A8,8,0,0,0,104,80v64a8,8,0,0,0,12.44,6.66l48-32a8,8,0,0,0,0-13.32ZM120,129.05V95l25.58,17ZM216,40H40A16,16,0,0,0,24,56V168a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,128H40V56H216V168Zm16,40a8,8,0,0,1-8,8H32a8,8,0,0,1,0-16H224A8,8,0,0,1,232,208Z" />, text: "Social Media" },
  { icon: <MIcon d="M197.58,129.06,146,110l-19-51.62a15.92,15.92,0,0,0-29.88,0L78,110l-51.62,19a15.92,15.92,0,0,0,0,29.88L78,178l19,51.62a15.92,15.92,0,0,0,29.88,0L146,178l51.62-19a15.92,15.92,0,0,0,0-29.88ZM137,164.22a8,8,0,0,0-4.74,4.74L112,223.85,91.78,169A8,8,0,0,0,87,164.22L32.15,144,87,123.78A8,8,0,0,0,91.78,119L112,64.15,132.22,119a8,8,0,0,0,4.74,4.74L191.85,144Z" />, text: "Icons" },
  { icon: <MIcon d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z" />, text: "Brand Visibility" },
  { icon: <MIcon d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208V208Zm-48-72a8,8,0,0,1-8,8H136v16a8,8,0,0,1-16,0V144H104a8,8,0,0,1,0-16h16V112a8,8,0,0,1,16,0v16h16A8,8,0,0,1,160,136Z" />, text: "Brand Integrations" },
];
