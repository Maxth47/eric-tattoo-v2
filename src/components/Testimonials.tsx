...
const reviews = [
  {
    ...
    quote:
      '"Getting my first tattoo with Eric was an incredible experience. He made me feel completely at ease, explained every step, and the result exceeded all my expectations. Absolutely stunning work!"',
    rating: "5.0",
  },
  {
    ...
    quote:
      '"Eric\'s work on my full sleeve was phenomenal. His attention to detail and ability to create a cohesive design across multiple sessions is unmatched. Every element flows perfectly together."',
    rating: "5.0",
  },
  {
    ...
    role: "Regular Client",
    quote:
      '"Eric\'s realism work is absolutely mind-blowing. The portrait he did for me looks like a photograph on my skin. His talent for capturing lifelike detail is truly remarkable."',
    rating: "5.0",
  },
  {
          ...
          <div className="flex flex-col items-start gap-6 flex-1 min-w-0 md:min-w-[460px] w-full md:w-auto">
            ...
            <Reveal variants={fadeUp} delay={0.15}>
              <p className="text-[20px] lg:text-[24px] leading-[1.4] text-[#ffffffa6] opacity-90 max-w-[640px] font-[family-name:var(--font-inter-display)]">
                Real feedback from clients who trusted my tattoo artistry to
            ...
            <Reveal variants={fadeUp} delay={0.2}>
              <div className="flex flex-wrap items-center gap-6">
                ...
                <SectionButton href="https://www.instagram.com/eric.le.tattoo/">See Styles</SectionButton>
              </div>
            </Reveal>
          </div>
        </div>
