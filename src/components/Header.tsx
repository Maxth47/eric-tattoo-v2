      ...
      <div className="flex items-center justify-between max-w-[1680px] mx-auto px-10">
        ...
        <div className="hidden md:flex items-center gap-8">
          <nav className="flex items-center gap-8">
            <a
              href="#services"
              className="text-[15px] text-white hover:text-white/65 transition-colors font-[family-name:var(--font-satoshi)]"
            >
              Services
            </a>
            <a
          ...
          <a
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgb(13, 13, 13) -74%, rgba(255, 255, 255, 0.1) 183%)",
              boxShadow:
